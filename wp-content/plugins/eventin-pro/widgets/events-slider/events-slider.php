...
class Etn_Pro_Events_Slider extends Widget_Base
{
    ...
    {
        return esc_html__('Eventin Events Slider Pro', 'eventin-pro');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_tab',
            [
                'label' => esc_html__('Eventin Event Slider Pro', 'eventin-pro'),
            ]
        );
        $this->add_control(
            'etn_event_style',
        ...
        $this->add_control(
            'etn_event_tag',
            [
                'label'    => esc_html__( 'Event Tag', 'eventin-pro' ),
                'type'     => Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'orderby',
            [
                'label'     => esc_html__( 'Order Event By', 'eventin-pro' ),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'post_date',
                'options'   => [
                    ...
                    'etn_start_date' => esc_html__( 'Event Start Date', 'eventin-pro' ),
                    'etn_end_date' => esc_html__( 'Event End Date', 'eventin-pro' ),
                ],
            ]
        );
        $this->add_control(
            'filter_with_status',
            [
                'label'     => esc_html__( 'Event status filter By', 'eventin-pro' ),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    ''        => esc_html__( 'All', 'eventin-pro' ),
                    'upcoming' => esc_html__( 'upcoming Event', 'eventin-pro' ),
                    'expire' => esc_html__( 'Expire Event', 'eventin-pro' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'show_event_location',
            [
                'label'   => esc_html__( 'Show Event Location', 'eventin-pro' ),
                'type'    => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'eventin-pro' ),
				'label_off' => esc_html__( 'No', 'eventin-pro' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'content_align',
			[
				'label' => __( 'Alignment', 'eventin-pro' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'eventin-pro' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'eventin-pro' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'eventin-pro' ),
				...
				'toggle' => true,
                'selectors'     => [
                    '{{WRAPPER}} .etn-event-item' => 'text-align: {{VALUE}};',
                ],
			]
		);
        ...
        $this->add_control(
            'show_end_date',
            [
                'label'     => esc_html__('Show End Date', 'eventin-pro'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Yes', 'eventin-pro'),
                'label_off' => esc_html__('No', 'eventin-pro'),
                'default'   => 'no',
				...
				$this->add_control(
					'show_child_event',
					[
							'label'   => esc_html__( 'Show Recurring Child Events', 'eventin-pro' ),
							'type'    => Controls_Manager::SWITCHER,
							'label_on' => esc_html__( 'Yes', 'eventin-pro' ),
							'label_off' => esc_html__( 'No', 'eventin-pro' ),
							'return_value' => 'yes',
        ...
        $this->add_control(
            'auto_play',
            [
                'label' => esc_html__('Auto Play', 'eventin-pro'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'eventin-pro'),
                'label_off' => esc_html__('Hide', 'eventin-pro'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .etn-event-slider .swiper-button-next, {{WRAPPER}} .etn-event-slider .swiper-button-prev, {{WRAPPER}} .etn-event-slider .swiper-pagination-bullet' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            'thumbnail_section',
            [
                'label' => esc_html__('Thumbnail Style', 'eventin-pro'),
                'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .etn-event-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $event_slider_count    = $settings["etn_event_slider_count"];
        ...
        include ETN_PRO_DIR . "/widgets/events-slider/style/{$style}.php";
    }
