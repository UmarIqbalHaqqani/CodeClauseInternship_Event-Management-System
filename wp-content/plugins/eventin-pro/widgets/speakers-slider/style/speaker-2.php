...
if ( !empty( $data ) ) { ?>
    <div class='etn-speaker-wrapper etn-speaker-slider speaker-style2' data-autoplay="<?php echo esc_attr($auto_play); ?>" data-space="<?php echo esc_attr($spaceBetween); ?>" data-count="<?php echo esc_attr($slider_count); ?>">
