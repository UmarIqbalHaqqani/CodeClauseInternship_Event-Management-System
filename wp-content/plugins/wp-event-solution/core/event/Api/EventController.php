...
class EventController extends WP_REST_Controller {
    ...
    public function update_item( $request ) {
        ...
        // Manage online event.
        $platform = is_array( $prepared_event['location'] ) ? $prepared_event['location']['integration'] : '';
    ...
    public function prepare_item_for_response( $item, $request ) {
        ...
        $event_data = [
            ...
            'organizer_group'         => $organizer_group ? $organizer_group : [],
            'speaker'                 => $speaker ? $speaker : [],
            'speaker_type'            => get_post_meta( $id, 'speaker_type', true ),
            'speaker_group'           => $speaker_group ? $speaker_group : [],
            ...
            'virtual'                 => get_post_meta( $id, 'virtual', true ),
