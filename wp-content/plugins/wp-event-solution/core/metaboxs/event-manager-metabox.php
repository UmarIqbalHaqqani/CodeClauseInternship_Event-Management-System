...
abstract class Event_manager_metabox extends Event_manager_repeater_metabox {
    ...
    public function save_meta_box_data( $post_id ) {
		...
		// google meet meta actions
		if ( class_exists('Etn_Pro\Core\Modules\Integrations\Google_Meet\Google_Meet') &&
		 !empty($this->report_box_id) &&  'etn-event-settings' == $this->report_box_id ) {
			
			\Etn_Pro\Core\Modules\Integrations\Google_Meet\Google_Meet::instance()->etn_create_google_meet_meeting( $post_id ); 
