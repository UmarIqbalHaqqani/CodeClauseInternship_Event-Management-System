...
class Hooks {
    ...
    /**
     * Update location if unorganized location added
     *
     * @return  void
     */
    public function update_event_location() {

        $update_location = get_option( 'etn_location_update' );
        ...
        $upgrade = new V_4_0_6();
        $upgrade->run();
        update_option( 'etn_location_update', 1 );
    }
}