...
Class MetForm_Next_Step extends Widget_Base{
	...
	public function get_title() {
		return esc_html__( 'Next Step', 'metform-pro' );
    }
	...
	public function get_keywords() {
        return ['metform', 'button', 'submit', 'submit button', 'next step'];
    }
    ...
    protected function render($instance = []){
		...
		<div class="mf-btn-wraper <?php echo esc_attr($class); ?>">
			<?php if($icon_align == 'right'): ?>
				<button type="submit"
						class="metform-btn metfrom-next-step <?php echo esc_attr( $btn_class ); ?>"
