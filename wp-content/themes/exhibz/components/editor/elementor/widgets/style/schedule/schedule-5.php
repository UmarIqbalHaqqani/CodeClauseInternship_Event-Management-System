												...
												<?php foreach ( $multiple_speaker as $key => $value ) { ?>
                                                    ...
                                                    <div class="speaker-content">
														...
														if ( isset( $value['attachment_id'] ) ) : ?>
															...
															<?php if ( $key == 1 ) : ?>
                                                                <a rel="noreferrer"
                                                                   href="<?php echo esc_url( get_the_permalink( $speaker_id_one ) ); ?>">
                                                                    <img class="schedule-slot-speakers <?php echo esc_attr( "speaker-img-" . $key ); ?>"
                                                                         src="<?php echo wp_get_attachment_url( $value["attachment_id"], 'thumbnail' ); ?>"
                                                                         title="<?php echo esc_attr( $speaker_one ); ?>"
                                                                         alt="<?php echo esc_attr( "speaker-" . $key ); ?>">
                                                                </a>
															<?php elseif ( $key == 2 ) : ?>
                                                                <a rel="noreferrer"
                                                                   href="<?php echo esc_url( get_the_permalink( $speaker_id_two ) ); ?>">
                                                                    <img class="schedule-slot-speakers <?php echo esc_attr( "speaker-img-" . $key ); ?>"
                                                                         src="<?php echo wp_get_attachment_url( $value["attachment_id"], 'thumbnail' ); ?>"
                                                                         title="<?php echo esc_attr( $speaker_two ); ?>"
                                                                         alt="<?php echo esc_attr( "speaker-" . $key ); ?>">
                                                                </a>
															<?php elseif ( $key == 3 ) : ?>
                                                                <a rel="noreferrer"
                                                                   href="<?php echo esc_url( get_the_permalink( $speaker_id_three ) ); ?>">
                                                                    <img class="schedule-slot-speakers <?php echo esc_attr( "speaker-img-" . $key ); ?>"
                                                                         src="<?php echo wp_get_attachment_url( $value["attachment_id"], 'thumbnail' ); ?>"
                                                                         title="<?php echo esc_attr( $speaker_three ); ?>"
                                                                         alt="<?php echo esc_attr( "speaker-" . $key ); ?>">
                                                                </a>
															<?php endif; ?>
