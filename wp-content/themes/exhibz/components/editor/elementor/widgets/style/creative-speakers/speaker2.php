                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="speakers-grid">
                        ...
                        foreach ($query as $post):
                            ...
                            ?>
                            <div class="business-speaker-item <?php echo esc_attr($item_class); ?>"
                                ...
                                <div class="speaker-content-wrappers">
                                    <div class="business-speaker-information">
                                        <h3 class="exh-speaker-two-title">
                                ...
                                <div class="etn-business-speakers-social">
                                        <?php
