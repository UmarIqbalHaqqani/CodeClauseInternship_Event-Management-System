...
if (is_array($data) && !empty($data)) {
    ...
    <div class="schedule-tab-wrapper etn-tab-wrapper <?php echo esc_attr($this->get_name()); ?>"
         ...
         <div class="schedule-content-wrapper row">
            <ul class='etn-nav col-md-12 col-lg-3 col-sm-12'>
                <?php
                $i = -1;
            ...
            <div class='etn-tab-content clearfix etn-schedule-wrap col-md-12 col-lg-9 col-sm-12'>
                <?php
                                        ...
                                        <div class="exhibz-schedule-content-row">
                                            ...
                                            if (is_array($etn_schedule_speaker) && !empty($etn_schedule_speaker)) : ?>
                                                ...
                                                <?php $swiper_class = \Elementor\Plugin::$instance->experiments->is_feature_active( 'e_swiper_latest' ) ? 'swiper' : 'swiper-container';?>
                                                    <div class='etn-schedule-speaker' data-controls="<?php echo esc_attr($slide_controls); ?>">
