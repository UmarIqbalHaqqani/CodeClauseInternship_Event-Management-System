...
class Exhibz_Creative_Speaker_Widget extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'speaker1',
                'options' => [
                    'speaker1' => esc_html__( 'Creative Speakers', 'exhibz' ),
                    'speaker2' => esc_html__( 'Business Speakers', 'exhibz' ),
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'       => '{{WRAPPER}} .exh-speaker-title, {{WRAPPER}} .exh-speaker-two-title',
            ]
        );
        $this->add_control(
            'speaker_name_color',
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .exh-speaker-two-title a' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .exh-speaker-two-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator'  => 'after',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .business-speaker-item .speaker-thumb img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a' => 'height: {{SIZE}}{{UNIT}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'       => '{{WRAPPER}} .etn-speakers-social, {{WRAPPER}} .etn-business-speakers-social a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a' => 'background-color: {{VALUE}}',
                ...
                'fields_options' => [
                    'border' => [
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .etn-business-speakers-social a' => 'border-style: {{VALUE}};',
                        ],
                    ],
                    'width'  => [
                        'default'   => [
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .etn-business-speakers-social a' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ],
                    'color'  => [
                        'default'   => '#E5E5E5',
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .etn-business-speakers-social a' => 'border-color: {{VALUE}};',
                        ],
                    ]
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
                ...
                'fields_options' => [
                    'border' => [
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .etn-business-speakers-social a:hover' => 'border-style: {{VALUE}};',
                        ],
                    ],
                    'width'  => [
                        'default'   => [
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .etn-business-speakers-social a:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        ],
                    ],
                    'color'  => [
                        'default'   => '#FFFFFF00',
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .etn-business-speakers-social a:hover' => 'border-color: {{VALUE}};',
                        ],
                    ]
                ]
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .etn-business-speakers-social a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render()
    {
        ...
        require "style/creative-speakers/{$style}.php";
    }
